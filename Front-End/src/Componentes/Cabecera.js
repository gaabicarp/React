...
<div className="logocabecera">
        ...
        <Dropdown>
          <Dropdown.Toggle variant="Secundary" id="dropdown-basic" size="sm">
            ...
            {auth.user.method == "google" ? <Avatar alt={auth.user.UserName} src={auth.user.profileImage} /> : <Avatar alt={auth.user.UserName} src={`http://localhost:4000${auth.user.profileImage}`} />}
